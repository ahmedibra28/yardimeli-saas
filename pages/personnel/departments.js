...
const Departments = () => {
  ...
  const { getDepartments, postDepartment, updateDepartment, deleteDepartment } =
    useDepartmentsHook({
      page,
      q,
    })
...
export default dynamic(() => Promise.resolve(withAuth(Departments)), {
  ssr: false,
})
